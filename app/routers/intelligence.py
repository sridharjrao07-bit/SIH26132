...
def sale_window(
    ...
    day1 = float(forecasts[0]["predicted_price"]) if forecasts and forecasts[0].get("predicted_price") is not None else None
    last_fc = float(forecasts[-1]["predicted_price"]) if forecasts and forecasts[-1].get("predicted_price") is not None else None
